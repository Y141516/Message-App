...
import { User, Hash, Phone, MapPin, Globe, Moon, Sun, LogOut, CheckCircle2, Shield, Languages, Trash2, AlertTriangle } from 'lucide-react';
          ...
          <AnimatePresence>
            {!showClearConfirm ? (
              ...
              <motion.div initial={{ opacity: 0, y: 8 }} animate={{ opacity: 1, y: 0 }}
                ...
                <p className="text-xs mb-4" style={{ color: 'var(--text-secondary)' }}>Choose what to delete. Cannot be undone.</p>
                <div className="space-y-2 mb-4">
                  {[
                    ...
                    <button key={opt.id} onClick={() => setClearMode(opt.id as any)}
                      ...
                      style={{ background: clearMode === opt.id ? 'rgba(239,68,68,0.1)' : 'var(--bg-elevated)', border: `1px solid ${clearMode === opt.id ? 'rgba(239,68,68,0.4)' : 'var(--border-subtle)'}` }}>
